db_host = "167.71.52.192"         # Server
db_port = "5432"                  # Server
db_database_name = "premiumroom"  # Server
db_user = "hito"                  # Server
db_password = "1523"              # Server
# db_host = "localhost"               # Dev
# db_port = "5432"                    # Dev
# db_database_name = "postgres"       # Dev
...
CHANNELS = [-1002175843444, -1002376349132, -1002546327250] # ALGO MM UZ CHANNEL, #GOLD CHANNEL # ALGO HELPER CHANNEL
